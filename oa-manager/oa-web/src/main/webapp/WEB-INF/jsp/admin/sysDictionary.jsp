  ...
  <body>
    <div class="easyui-layout" data-options="fit:'true' ">
		...
		<div data-options="region:'center' ">
			<table id="sysDictionaryGrid"></table>
		</div>
		...
		<div id="dlg" class="easyui-dialog" style="width:450px;height:360px;" 
	    	...
	    	<form id="fm" method="post" novalidate>
	    		...
	    		<table class="form-table">
		    		<tr>
		    			<td class="form-td-left"> 父编码:</td>
		    			<td><input class="easyui-numberbox form-input" name="pid" 
		    				data-options="missingMessage:'请填写父编码', " maxlength="" />
		    			</td>
		    		</tr>
		    		<tr>
		    			<td class="form-td-left"> 类型编码:</td>
		    			<td><input class="easyui-textbox form-input" name="typeCode" 
		    				data-options="missingMessage:'请填写类型编码', " maxlength="50" />
		    			</td>
		    		</tr>
		    		<tr>
		    			<td class="form-td-left"> 显示的文字:</td>
		    			<td><input class="easyui-textbox form-input" name="name" 
		    				data-options="missingMessage:'请填写显示的文字', " maxlength="50" />
		    			</td>
		    		</tr>
		    		<tr>
		    			<td class="form-td-left"> 存的具体值:</td>
		    			<td><input class="easyui-textbox form-input" name="value" 
		    				data-options="missingMessage:'请填写存的具体值', " maxlength="50" />
		    			</td>
		    		</tr>
		    		<tr>
		    			<td class="form-td-left"> 描述:</td>
		    			<td><input class="easyui-textbox form-input" name="descs" 
		    				data-options="missingMessage:'请填写描述', " maxlength="500" />
		    			</td>
		    		</tr>
		    		<tr>
		    			<td class="form-td-left"> 状态，0不可用 1可用:</td>
		    			<td><input class="easyui-textbox form-input" name="state" 
		    				data-options="missingMessage:'请填写状态，0不可用 1可用', " maxlength="2" />
		    			</td>
		    		</tr>
		    		<tr>
...
<script type="text/javascript">
	...
	$(function(){
		...
		$grid.datagrid({
			...
			url:'${path}/sysDictionary/list', 
		    columns:[[
		        {field:'ck', width:50, checkbox: true},
				{field:'pid',title:'父编码'},    
				{field:'typeCode',title:'类型编码'},    
				{field:'name',title:'显示的文字'},    
				{field:'value',title:'存的具体值'},    
				{field:'descs',title:'描述'},    
				{field:'state',title:'状态，0不可用 1可用'},    
