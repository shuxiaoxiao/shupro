	    		...
	    		<table class="form-table">
		    		<tr>
		    			...
		    			<td><input class="easyui-textbox form-input" name="name" 
		    				data-options="missingMessage:'请填写菜单名称', " maxlength="500" />
		    			</td>
		    		</tr>
		    		<tr>
		    			<td class="form-td-left"> 父id:</td>
		    			<td><input class="easyui-numberbox form-input" name="pid" 
		    				data-options="missingMessage:'请填写父id', " maxlength="" />
		    			</td>
		    		</tr>
		    		<tr>
		    		...
		    		<tr>
		    			...
		    			<td><input class="easyui-textbox form-input" name="requestUrl" 
		    				data-options="missingMessage:'请填写请求路径', " maxlength="200" />
		    			</td>
		    		</tr>
		    		<tr>
		    			<td class="form-td-left"> 菜单类型,1菜单 2按钮:</td>
		    			<td><input class="easyui-textbox form-input" name="menuType" 
		    				data-options="missingMessage:'请填写菜单类型,1菜单 2按钮', " maxlength="10" />
		    			</td>
		    		</tr>
		    		<tr>
	...
	$(function(){
		...
		$grid.datagrid({
		    ...
		    columns:[[
				...
				{field:'menuType',title:'菜单类型,1菜单 2按钮'},    
